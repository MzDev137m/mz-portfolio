...
const projects = [
  {
    ...
    metrics: [{ label: 'Employees Managed', value: '500+' }, { label: 'Reports Generated', value: '50+' }, { label: 'Modules', value: '12' }],
  },
  {
    ...
    metrics: [{ label: 'Transactions/Day', value: '10K+' }, { label: 'SQL Procedures', value: '80+' }, { label: 'Report Types', value: '25' }],
  },
  {
    ...
    metrics: [{ label: 'Sections', value: '8' }, { label: 'Admin Modules', value: '5' }, { label: 'Uptime', value: '100%' }],
  },
  {
    ...
    metrics: [{ label: 'Products', value: '100+' }, { label: 'Admin Features', value: '15+' }, { label: 'Mobile Ready', value: '100%' }],
  },
  {
    ...
    metrics: [{ label: 'Daily Users', value: '200+' }, { label: 'Items Tracked', value: '500+' }, { label: 'Uptime', value: '99.9%' }],
  },
  {
    id: 6, name: 'SQL Performance Engine', label: 'Infrastructure', icon: '⚡', color: '#8b5cf6', year: '2023', status: 'Ongoing',
    desc: 'Database optimization framework — query performance analysis, index strategy implementation, execution plan tuning, and automated performance monitoring scripts.',
    ...
    metrics: [{ label: 'Query Speed Gain', value: '80%' }, { label: 'DB Size Handled', value: '50GB+' }, { label: 'Procedures Written', value: '150+' }],
  },
  {
    ...
    metrics: [{ label: 'Workflows Built', value: '20+' }, { label: 'Approvals/Month', value: '2K+' }, { label: 'Modules Integrated', value: '8' }],
  },
  {
    ...
    metrics: [{ label: 'Dashboard Widgets', value: '40+' }, { label: 'Report Templates', value: '60+' }, { label: 'Daily Reports Sent', value: '15' }],
  },
  {
    id: 9, name: 'Cinematic Portfolio Platform', label: 'Web Application', icon: '🌐', color: '#34d399', year: '2025', status: 'Production',
    desc: 'This portfolio — built with Next.js 16, Framer Motion, GSAP, canvas particle animations, magnetic buttons, text scramble effects, and 3D mouse-parallax interactions.',
    tech: ['Next.js 16', 'React 18', 'Framer Motion', 'GSAP', 'Tailwind CSS', 'Canvas API'],
    features: ['Canvas Particle Network', 'Text Scramble Animation', 'Magnetic CTA Buttons', 'Letter-by-letter Reveal', 'GSAP ScrollTrigger Timeline'],
    metrics: [{ label: 'Sections', value: '7' }, { label: 'Animations', value: '30+' }, { label: 'Performance', value: '98+' }],
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((p, i) => (
            <motion.div key={p.id}
              ...
              <div className="h-[2px] w-full" style={{ background: `linear-gradient(90deg, ${p.color}, ${p.color}44)` }} />
                ...
                <div className="flex gap-4 mb-4 pb-4 border-b border-white/5">
                  {p.metrics.map(m => (
                    <div key={m.label}>
                      ...
                      <div className="font-mono text-[9px] text-slate/40 mt-0.5">{m.label}</div>
                    </div>
                  ))}
                </div>
                ...
                {active === p.id && (
                  <motion.div className="px-6 pb-6"
                    ...
                    <div className="border-t border-white/5 pt-4">
                      <div className="font-mono text-[10px] tracking-[.3em] uppercase mb-3" style={{ color: p.color }}>Key Features</div>
              ...
              <div className="absolute bottom-3 right-4 font-mono text-[10px] text-slate/30">
